...
class ConditionTokens(nn.Module):
    def __init__(self, num_conditions, embed_dim=512, hidden_dim=[128, 256],  use_self_attention=False, n_heads=8, n_layers=1, use_gelu=False):
        """
        ...
        self.projections = nn.ModuleList([
            self.make_mlp(1, hidden_dim, embed_dim, dropout=0.1)
